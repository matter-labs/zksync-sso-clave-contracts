...
describe('util', () => {
  ...
  describe('getFavicon', () => {
    test('return https', () => {
      ...
      <link rel="shortcut icon" sizes="16x16 24x24" href="https://zksync.io/favicon.ico">
    `;
      expect(getFavicon()).toEqual('https://zksync.io/favicon.ico');
    });

    test('return http', () => {
      document.head.innerHTML = `
      <link rel="shortcut icon" sizes="16x16 24x24" href="//zksync.io/favicon.ico">
    `;
      expect(getFavicon()).toEqual('http://zksync.io/favicon.ico');
    });
